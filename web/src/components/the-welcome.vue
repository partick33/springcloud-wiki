<template>
  <div>
    <div class="tip">
      <div><b>网站开发技术说明：</b></div>
      <div><b>后端框架：SpringCloud Nacos+ OpenFeign + GateWay + mysql </b></div>
      <div><b>前端框架：vue3 + ant design of vue</b></div>
      <div><b>中间件：redis + rabbitMQ + elasticsearch </b></div>
    </div>
